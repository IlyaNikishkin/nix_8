        ...
        <div class="col-12">
            <div class="card mt-2">
                <div class="card-header">
                    <h4>New student in group ${groupName}</h4>
                </div>
                <div class="card-body">
                <c:if test="${message != ''}">
                    <strong><c:out value="${message}"/></strong>
                </c:if>
                    <form:form action = "${pageContext.request.contextPath}/groups/${group.getId()}/students/new" method = "post" modelAttribute="student">
