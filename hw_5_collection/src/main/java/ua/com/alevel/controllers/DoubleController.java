...
public class DoubleController {
    ...
    private static final MathSet<Double> mathSet = new MathSet<>();

    public void run() {
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
        String position;
        try {
            System.out.println("Double MathSet");
            runNavigation();
    ...
    private void join(BufferedReader reader) {
        ...
        if (mathSet.size() != 0) {
            try {
                ...
                MathSet<Double> anotherMathSet = new MathSet<>(numbers);
                out(mathSet);
                System.out.print(" U ");
                out(anotherMathSet);
                System.out.print("\nResult: ");
    ...
    private void sortDescByValue(BufferedReader reader) {
        if (mathSet.size() != 0) {
            ...
            try {
                mathSet.sortDesc(Double.parseDouble(reader.readLine()));
                System.out.print("Result: ");
                out(mathSet);
                System.out.println();
            } catch (Exception e) {
    ...
    private void sortAscByValue(BufferedReader reader) {
        if (mathSet.size() != 0) {
            System.out.print("Enter value: ");
            try {
                mathSet.sortAsc(Double.parseDouble(reader.readLine()));
                System.out.print("Result: ");
                out(mathSet);
                System.out.println();
            } catch (Exception e) {
    ...
    private void out(MathSet<Double> mathSet) {
